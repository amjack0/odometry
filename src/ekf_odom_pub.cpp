...
const double TICKS_PER_REVOLUTION = 145000; // For reference purposes.
const double WHEEL_RADIUS = 0.078139998; // Wheel radius in meters
const double WHEEL_BASE = 0.696; // Center of left tire to center of right tire // TODO
const double TICKS_PER_METER = 295216.05437839; // Original was 2800
